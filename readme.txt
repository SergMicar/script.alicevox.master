...
Особенности:
В силу специфики плеера системных звуков KODI (через который реализовано воспроизведение) - любая команда на воспроизведение звука через плагин будет приводть или к снятию с паузы воспроизводимого контента (если он в момент ТТС стоял на паузе), или ожиданию "ручного" снятия с паузы с последующим вопроизведением звука. Поведение настраиватся в настройках самого плагина.
